...
public abstract class AbstractCombatActorPiece2 : AbstractCombatPiece2, IStartTurnEndTurn, ICommandablePiece
{
    ...
    */
    ...
    {
        AbstractCombatActorPiece2 targetCombatPiece = targetPiece as AbstractCombatActorPiece2;
